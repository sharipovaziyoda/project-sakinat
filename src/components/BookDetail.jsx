const BookDetail = ({ item, onClose }) => {
  // PDF va Audio kitoblar mavjudligini tekshirish
  const isPdfAvailable = item.pdf && item.pdf !== "Hozirda pdf kitob mavjud emas";
  const isAudioAvailable = item.audio && item.audio !== "Hozirda audio kitob mavjud emas";
        ...
        <div className="flex-1">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-4">
            {isPdfAvailable ? (
              ...
              <p className="text-red-500 font-medium">PDF mavjud emas</p> // Agar PDF mavjud bo'lmasa
            )}
            ...
            {isAudioAvailable ? (
              ...
              <p className="text-red-500 font-medium">Audiokitob mavjud emas</p> // Agar audio mavjud bo'lmasa
            )}
          </div>
        </div>
      </div>
